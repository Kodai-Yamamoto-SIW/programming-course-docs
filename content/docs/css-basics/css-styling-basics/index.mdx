...
import cssStylingBasicsCompleteZipUrl from './assets/css-styling-basics-complete.zip';
...
<DownloadLink file={cssStylingBasicsCompleteZipUrl} filename="css-styling-basics-complete.zip">
