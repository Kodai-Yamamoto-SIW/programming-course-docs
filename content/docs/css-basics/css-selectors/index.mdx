...
<Hint>
選択肢を選ぶ前に、「用語の確認（選択式）」と `.p`・`#p` の役割を直前の説明に戻って確認しましょう。似ている記号や書き方は、対象になる範囲がどう変わるかで見分けます。
</Hint>
...
クラス aka だけを赤にしたい。空欄**\_**を埋めてください。
...
<Hint>
空欄を埋める前に、「穴埋め（クラス）」と `.aka` が「どの対象を選ぶ指定」なのかを確認しましょう。期待結果に必要な対象だけに絞ると、余計な部分まで変えずに済みます。
</Hint>
...
<Hint>
選択肢を選ぶ前に、「グループセレクタ（選択式）」の役割を直前の説明に戻って確認しましょう。似ている記号や書き方は、対象になる範囲がどう変わるかで見分けます。
</Hint>
...
<Hint>
答える前に、「全称セレクタ（正誤）」と `*` が「いつ・どこに効く指定」なのかを確認しましょう。便利そうに見えても、影響範囲が広すぎないかを考えると判断しやすくなります。
</Hint>
...
<Hint>
選択肢を選ぶ前に、「子孫と子（選択式）」と `.oya p`・`.oya > p` の役割を直前の説明に戻って確認しましょう。似ている記号や書き方は、対象になる範囲がどう変わるかで見分けます。
</Hint>
...
<Hint>
コードを書く前に、問題文のHTMLで指定を当てたい要素を先に確認しましょう。`#00A152`・`.oya` は、対象を決めたあとに必要なタグ・セレクタ・値として入れると迷いにくくなります。
</Hint>
...
<Hint>
コードを書く前に、問題文のHTMLで指定を当てたい要素を先に確認しましょう。`#E91E63`・`.menu` は、対象を決めたあとに必要なタグ・セレクタ・値として入れると迷いにくくなります。
</Hint>
...
<Hint>
まず「hover の考え方（記述）」で確認したい結果を一文で言い換えてみましょう。その結果に直接関係する要素やプロパティだけを選ぶと、答えに近づけます。
</Hint>
...
<Hint>
コードを書く前に、問題文のHTMLで指定を当てたい要素を先に確認しましょう。`#E91E63`・`.aka` は、対象を決めたあとに必要なタグ・セレクタ・値として入れると迷いにくくなります。
</Hint>
...
<Hint>
コードを書く前に、問題文のHTMLで指定を当てたい要素を先に確認しましょう。`#1565FF`・`#E91E63`・`.ichiran` は、対象を決めたあとに必要なタグ・セレクタ・値として入れると迷いにくくなります。
</Hint>
...
<Hint>
コードを書く前に、問題文のHTMLで指定を当てたい要素を先に確認しましょう。`#00A152`・`.honbun`・`.aka` は、対象を決めたあとに必要なタグ・セレクタ・値として入れると迷いにくくなります。
</Hint>
...
<Hint>
選択肢を選ぶ前に、「組み合わせの見分け（選択式）」と `.honbun p`・`h2.midashi` の役割を直前の説明に戻って確認しましょう。似ている記号や書き方は、対象になる範囲がどう変わるかで見分けます。
</Hint>
...
<Hint>
選択肢を選ぶ前に、「特異性（選択式）」の役割を直前の説明に戻って確認しましょう。似ている記号や書き方は、対象になる範囲がどう変わるかで見分けます。
</Hint>
...
<Hint>
コードを書く前に、問題文のHTMLで指定を当てたい要素を先に確認しましょう。`.aka`・`#tokubetsu` は、対象を決めたあとに必要なタグ・セレクタ・値として入れると迷いにくくなります。
</Hint>
...
<Exercise>
「h2 で、クラス midashi を持ち、マウスを重ねたとき」に当てたい。空欄**\_**を埋めてください。
...
<Hint>
空欄を埋める前に、「穴埋め（組み合わせ）」が「どの対象を選ぶ指定」なのかを確認しましょう。期待結果に必要な対象だけに絞ると、余計な部分まで変えずに済みます。
</Hint>
...
<Hint>
コードを書く前に、問題文のHTMLで指定を当てたい要素を先に確認しましょう。`#1565FF` は、対象を決めたあとに必要なタグ・セレクタ・値として入れると迷いにくくなります。
</Hint>
...
<Hint>
コードを書く前に、問題文のHTMLで指定を当てたい要素を先に確認しましょう。`#1565FF`・`#6200EA`・`#00A152` は、対象を決めたあとに必要なタグ・セレクタ・値として入れると迷いにくくなります。
</Hint>
