...
import parallax1Url from './img/parallax1.jpg';
import parallax2Url from './img/parallax2.jpg';
import parallax3Url from './img/parallax3.jpg';
...
<CodePreview
  sourceId="bg-exercise-1"
  fileStructureVisible={true}
  previewVisible={true}
  htmlVisible={false}
  cssVisible={false}
  cssPath="css/style.css"
  images={{ "img/image1.png": backgroundSampleUrl }}
>
```html
<div>この div の背景に画像をつける</div>
```
...
<Hint>
コードを書く前に、問題文のHTMLで指定を当てたい要素を先に確認しましょう。`index.html`・`#d9e5ff` は、対象を決めたあとに必要なタグ・セレクタ・値として入れると迷いにくくなります。
</Hint>
...
<CodePreview
  sourceId="bg-exercise-2"
  fileStructureVisible={true}
  previewVisible={true}
  htmlVisible={false}
  cssVisible={false}
  cssPath="css/style.css"
  images={{ "css/image2.png": backgroundSampleUrl }}
>
```html
<div>この div の背景に画像をつける</div>
```
...
<Hint>
コードを書く前に、問題文のHTMLで指定を当てたい要素を先に確認しましょう。`#d9e5ff` は、対象を決めたあとに必要なタグ・セレクタ・値として入れると迷いにくくなります。
</Hint>
...
<Hint>
コードを書く前に、問題文のHTMLで指定を当てたい要素を先に確認しましょう。`#fff2d9` は、対象を決めたあとに必要なタグ・セレクタ・値として入れると迷いにくくなります。
</Hint>
...
<Hint>
コードを書く前に、問題文のHTMLで指定を当てたい要素を先に確認しましょう。`#f0f0f0` は、対象を決めたあとに必要なタグ・セレクタ・値として入れると迷いにくくなります。
</Hint>
...
<div class="parent">
    <div class="loc">
        local（要素の内容と一緒に動く）<br>行1<br>行2<br>行3<br>行4<br>行5<br>行6<br>行7<br>行8<br>行9<br>行10
    </div>
    <div class="scr">
        scroll（初期。要素とは一緒に動くが、内容とは一緒に動かない）<br>行1<br>行2<br>行3<br>行4<br>行5<br>行6<br>行7<br>行8<br>行9<br>行10
    </div>
    <div class="fix">
        fixed（画面に固定）<br>行1<br>行2<br>行3<br>行4<br>行5<br>行6<br>行7<br>行8<br>行9<br>行10
    </div>
</div>
```
...
<CodePreview
  images={{
    "img/parallax1.jpg": parallax1Url,
    "img/parallax2.jpg": parallax2Url,
    "img/parallax3.jpg": parallax3Url
  }}
>
```html
...
デザインへのリンク: [Figma デザイン](https://www.figma.com/design/gPrpQCYBcG9JHotsbEjTwI/backgrounds-practice?node-id=0-1&t=8azfKNFnsyZ0LSy8-1)
