...
<CodePreview 
  images={{ "img/background-sample.png": new URL("./img/background-sample.png", import.meta.url).toString() }}
>
```html
<div>背景画像のサンプル</div>
```
...
<CodePreview
  ...
  images={{ "img/image1.png": new URL("./img/background-sample.png", import.meta.url).toString() }}
>
```html
<div>この div の背景に画像をつける</div>
```
...
<CodePreview
  ...
  cssVisible={false}
  cssPath="css/style.css"
  images={{ "css/image2.png": new URL("./img/background-sample.png", import.meta.url).toString() }}
>
```html
<div>この div の背景に画像をつける</div>
```
...
下の例では、プレビュー内をスクロールしてみると背景画像が固定されていて、白い帯（テキスト）だけが動くので、奥行きがあるように見えます。

<CodePreview 
  images={{ "img/parallax1.jpg": new URL("./img/parallax1.jpg", import.meta.url).toString(), "img/parallax2.jpg": new URL("./img/parallax2.jpg", import.meta.url).toString(), "img/parallax3.jpg": new URL("./img/parallax3.jpg", import.meta.url).toString() }}
>
```html
<div class="content">
  <p>最初のコンテンツ領域です。</p>
...
### 著作権元
<p style={{ fontSize: "0.8em" }}><a href="https://www.figma.com/community/file/788675347108478517/mntn-landing-page" target="_blank" rel="noopener noreferrer">上述のデザインの元デザイン</a></p>
