...
<CodePreview
  ...
  cssVisible={false}
  images={{
 "img/fence.png": new URL("./img/fence.png", import.meta.url).toString() 
  }}
...
<CodePreview
  images={{ "img/red_tapes.png": new URL("./img/red_tapes.png", import.meta.url).toString(), "img/trains.png": new URL("./img/trains.png", import.meta.url).toString() }}
>
```html
...
<CodePreview
  ...
  cssVisible={false}
  images={{
 "img/dinosaur.png": new URL("./img/docusaurus.png", import.meta.url).toString(), "img/fence.png": new URL("./img/fence.png", import.meta.url).toString() 
  }}
  cssPath="css/style.css"
>
```html
...
<CodePreview
  ...
  images={{
    ...
    "img/badge.png": new URL("./img/badge.png", import.meta.url).toString(),
    "img/ribbon.png": new URL("./img/ribbon.png", import.meta.url).toString(),
    "img/pattern.jpg": new URL("./img/pattern.jpg", import.meta.url).toString()
...
### 著作権元
<p style={{ fontSize: "0.8em" }}><a href="https://www.figma.com/community/file/993910904620677970/travel-website-landing-page" target="_blank" rel="noopener noreferrer">上述のデザインの元デザイン</a></p>
