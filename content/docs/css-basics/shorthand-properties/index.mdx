import backgroundSampleUrl from './img/background-sample.png';
import badgeImageUrl from './img/badge.png';
import dinosaurImageUrl from './img/docusaurus.png';
import fenceImageUrl from './img/fence.png';
import patternImageUrl from './img/pattern.jpg';
import redTapesImageUrl from './img/red_tapes.png';
import ribbonImageUrl from './img/ribbon.png';
import trainsImageUrl from './img/trains.png';
...
<Hint>
コードを書く前に、問題文のHTMLで指定を当てたい要素を先に確認しましょう。`.atama`・`.naka`・`.sita` は、対象を決めたあとに必要なタグ・セレクタ・値として入れると迷いにくくなります。
</Hint>
...
<Hint>
コードを書く前に、問題文のHTMLで指定を当てたい要素を先に確認しましょう。`.midashi1`・`.honbun` は、対象を決めたあとに必要なタグ・セレクタ・値として入れると迷いにくくなります。
</Hint>
...
<Hint>
コードを書く前に、問題文のHTMLで指定を当てたい要素を先に確認しましょう。`.meigen`・`.sakusha`・`.setsumei` は、対象を決めたあとに必要なタグ・セレクタ・値として入れると迷いにくくなります。
</Hint>
...
<CodePreview
  cssPath="style.css"
  images={{ "img/background-sample.png": backgroundSampleUrl }}
>
```html
<div class="box1">一括指定</div>
<div class="box2">個別指定</div>
...
<Hint>
コードを書く前に、問題文のHTMLで指定を当てたい要素を先に確認しましょう。`.ookii`・`.kaado`・`#f0f8ff` は、対象を決めたあとに必要なタグ・セレクタ・値として入れると迷いにくくなります。
</Hint>
...
```css
.koe {
    background: url('../img/fence.png') repeat-x left bottom / 120px auto
        #e3f2fd;
    width: 800px;
    height: 250px;
}
...
<Hint>
コードを書く前に、問題文のHTMLで指定を当てたい要素を先に確認しましょう。`<position>`・`<size>`・`<position> / <size>` は、対象を決めたあとに必要なタグ・セレクタ・値として入れると迷いにくくなります。
</Hint>
...
<CodePreview
  images={{ "img/red_tapes.png": redTapesImageUrl, "img/trains.png": trainsImageUrl }}
>
```html
...
<CodePreview
  ...
  cssVisible={false}
  images={{
 "img/dinosaur.png": dinosaurImageUrl, "img/fence.png": fenceImageUrl
  }}
  cssPath="css/style.css"
>
```html
...
<Hint>
コードを書く前に、問題文のHTMLで指定を当てたい要素を先に確認しましょう。`.kasane1`・`#f0f8ff` は、対象を決めたあとに必要なタグ・セレクタ・値として入れると迷いにくくなります。
</Hint>
...
<CodePreview
  ...
  cssVisible={false}
  images={{
    "img/badge.png": badgeImageUrl,
    "img/ribbon.png": ribbonImageUrl,
    "img/pattern.jpg": patternImageUrl
  }}
  cssPath="css/style.css"
>
```html
...
<Hint>
コードを書く前に、問題文のHTMLで指定を当てたい要素を先に確認しましょう。`.campaign` は、対象を決めたあとに必要なタグ・セレクタ・値として入れると迷いにくくなります。
</Hint>
...
デザインへのリンク: [Figma デザイン](https://www.figma.com/design/gJBGYlSMeqickBiBXCLuVI/shorthand-property-practice?node-id=0-1&t=JGIWuj6jvssdAzn3-1)
