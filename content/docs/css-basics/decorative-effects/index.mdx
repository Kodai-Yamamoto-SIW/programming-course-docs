...
<Hint>
コードを書く前に、問題文のHTMLで指定を当てたい要素を先に確認しましょう。`.btn`・`#4a90e2` は、対象を決めたあとに必要なタグ・セレクタ・値として入れると迷いにくくなります。
</Hint>
...
<Hint>
コードを書く前に、問題文のHTMLで指定を当てたい要素を先に確認しましょう。`.icon`・`#ff6b6b` は、対象を決めたあとに必要なタグ・セレクタ・値として入れると迷いにくくなります。
</Hint>
...
<Hint>
コードを書く前に、問題文のHTMLで指定を当てたい要素を先に確認しましょう。`.speech`・`#ffeaa7`・`#2d3436` は、対象を決めたあとに必要なタグ・セレクタ・値として入れると迷いにくくなります。
</Hint>
...
<Hint>
コードを書く前に、問題文のHTMLで指定を当てたい要素を先に確認しましょう。`.heading`・`#2c3e50` は、対象を決めたあとに必要なタグ・セレクタ・値として入れると迷いにくくなります。
</Hint>
...
<Hint>
コードを書く前に、問題文のHTMLで指定を当てたい要素を先に確認しましょう。`.card` は、対象を決めたあとに必要なタグ・セレクタ・値として入れると迷いにくくなります。
</Hint>
...
<Hint>
コードを書く前に、問題文のHTMLで指定を当てたい要素を先に確認しましょう。`.banner`・`#ff6b6b`・`#4ecdc4` は、対象を決めたあとに必要なタグ・セレクタ・値として入れると迷いにくくなります。
</Hint>
...
<Hint>
コードを書く前に、問題文のHTMLで指定を当てたい要素を先に確認しましょう。`.circle-btn`・`#6bcf7f`・`#4a90e2` は、対象を決めたあとに必要なタグ・セレクタ・値として入れると迷いにくくなります。
</Hint>
...
<Hint>
コードを書く前に、問題文のHTMLで指定を当てたい要素を先に確認しましょう。`.special-card`・`#f093fb`・`#f5576c` は、対象を決めたあとに必要なタグ・セレクタ・値として入れると迷いにくくなります。
</Hint>
...
デザインへのリンク: [Figma デザイン](https://www.figma.com/design/nAh5Afbk4orz7pzNTkWXTi/Cooking-Template-%F0%9F%9F%A3-by-Flowbase.co--Community-?node-id=1-296&t=E5hswHM2pZZuyH0L-1)

### 著作権元

<p style={{ fontSize: '0.8em' }}>
  <a
    href="https://www.figma.com/community/file/1093372331682706566"
    target="_blank"
