...
<Hint>
コードを書く前に、問題文のHTMLで指定を当てたい要素を先に確認しましょう。`.card`・`.card-title`・`.card-text` は、対象を決めたあとに必要なタグ・セレクタ・値として入れると迷いにくくなります。
</Hint>
...
<Hint>
コードを書く前に、問題文のHTMLで指定を当てたい要素を先に確認しましょう。`.actions`・`.btn`・`.badge` は、対象を決めたあとに必要なタグ・セレクタ・値として入れると迷いにくくなります。
</Hint>
...
<Hint>
コードを書く前に、問題文のHTMLで指定を当てたい要素を先に確認しましょう。`.services`・`.service-card`・`#ddd` は、対象を決めたあとに必要なタグ・セレクタ・値として入れると迷いにくくなります。
</Hint>
...
<header class="site-header">
    ...
    <div class="site-actions">
        <div class="search-box">
            <input
                type="text"
                placeholder="ここに検索したいワードを入力して色々検索します">
...
<Hint>
コードを書く前に、問題文のHTMLで指定を当てたい要素を先に確認しましょう。`.site-header`・`.site-logo`・`.site-nav` は、対象を決めたあとに必要なタグ・セレクタ・値として入れると迷いにくくなります。
</Hint>
...
<div class="layout">
    <main class="main">
        <article class="post">
            ...
            <h2>レイアウト練習ブログ</h2>
            <p>
                このページではCSSレイアウトの練習をしています。CSSのflexboxを使うと柔軟なレイアウトが実現できます。
            </p>
        </article>
        <article class="post">
            ...
            <h2>Flexboxの使い方</h2>
            <p>
                文章量が増えても、読みやすい幅に保つことが大切です。レスポンシブデザインにも対応できます。
            </p>
        </article>
    </main>
    <aside class="sidebar">
...
<Hint>
コードを書く前に、問題文のHTMLで指定を当てたい要素を先に確認しましょう。`.layout`・`.main`・`.post` は、対象を決めたあとに必要なタグ・セレクタ・値として入れると迷いにくくなります。
</Hint>
