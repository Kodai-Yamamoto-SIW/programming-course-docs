...
<Hint>
コードを書く前に、問題文のHTMLで指定を当てたい要素を先に確認しましょう。`.item1`・`.item2` は、対象を決めたあとに必要なタグ・セレクタ・値として入れると迷いにくくなります。
</Hint>
...
<Hint>
コードを書く前に、問題文のHTMLで指定を当てたい要素を先に確認しましょう。`.box`・`.box2` は、対象を決めたあとに必要なタグ・セレクタ・値として入れると迷いにくくなります。
</Hint>
...
```html
<p>
    おすすめの<!-- display: inline、背景色yellow、左右パディング4px 8px --><span
        class="highlight"
        >商品</span
    >をご紹介します。
</p>
...
<Hint>
コードを書く前に、問題文のHTMLで指定を当てたい要素を先に確認しましょう。`.highlight`・`.menu1`・`.menu2` は、対象を決めたあとに必要なタグ・セレクタ・値として入れると迷いにくくなります。
</Hint>
...
```html
<p>
    これは<span class="small">小さい文字</span>と<span class="large"
        >大きい文字</span
    >が混在する文章です。インライン表示では、文字のベースラインが揃います。
</p>
...
<Hint>
コードを書く前に、問題文のHTMLで指定を当てたい要素を先に確認しましょう。`.small`・`.large`・`.huge` は、対象を決めたあとに必要なタグ・セレクタ・値として入れると迷いにくくなります。
</Hint>
...
<Hint>
コードを書く前に、問題文のHTMLで指定を当てたい要素を先に確認しましょう。`.button1`・`.button2` は、対象を決めたあとに必要なタグ・セレクタ・値として入れると迷いにくくなります。
</Hint>
...
<div class="cards">
    ...
    <div class="card">
        <h4>カードC</h4>
        <p>
            とても長い説明文が入る場合もあります。このようにテキストが長く改行が必要な場合は、デフォルトでテキストの下端の位置で揃えられます。
        </p>
    </div>
</div>
```
...
<Hint>
コードを書く前に、問題文のHTMLで指定を当てたい要素を先に確認しましょう。`.cards`・`.card` は、対象を決めたあとに必要なタグ・セレクタ・値として入れると迷いにくくなります。
</Hint>
...
デザインへのリンク: [Figma デザイン](https://www.figma.com/design/htidPJWOXpwICYsTWvBbD2/eCommerce-Website-%7C-Web-Page-Design-%7C-UI-KIT-%7C-Interior-Landing-Page--Community-?node-id=0-1&t=A6hbE2M4a5DDy0Jk-1)

### 著作権元

<p style={{ fontSize: '0.8em' }}>
  <a
    href="https://www.figma.com/community/file/1252561852327562039/ecommerce-website-web-page-design-ui-kit-interior-landing-page"
    target="_blank"
