...
>
```html
<div style="height: 4000px; background: #f7f7f7; padding: 8px">
    長いページ（スクロール）
</div>
<!-- ↓この要素にCSSを適用 -->
...
<Hint>
コードを書く前に、問題文のHTMLで指定を当てたい要素を先に確認しましょう。`.top`・`#f7f7f7`・`#1976d2` は、対象を決めたあとに必要なタグ・セレクタ・値として入れると迷いにくくなります。
</Hint>
...
<Hint>
コードを書く前に、問題文のHTMLで指定を当てたい要素を先に確認しましょう。`top`・`left`・`50%` は、対象を決めたあとに必要なタグ・セレクタ・値として入れると迷いにくくなります。
</Hint>
...
<Hint>
コードを書く前に、問題文のHTMLで指定を当てたい要素を先に確認しましょう。`.hero`・`.pin`・`#667eea` は、対象を決めたあとに必要なタグ・セレクタ・値として入れると迷いにくくなります。
</Hint>
...
<body style="display: flex; gap: 16px">
    ...
    <section style="flex: 1; border: 1px solid #ddd; padding: 8px">
        本文…
...
<Hint>
コードを書く前に、問題文のHTMLで指定を当てたい要素を先に確認しましょう。`.sidebar`・`#ddd`・`#ccc` は、対象を決めたあとに必要なタグ・セレクタ・値として入れると迷いにくくなります。
</Hint>
...
<Hint>
コードを書く前に、問題文のHTMLで指定を当てたい要素を先に確認しましょう。`.head`・`.page`・`#f7f7f7` は、対象を決めたあとに必要なタグ・セレクタ・値として入れると迷いにくくなります。
</Hint>
...
<Hint>
コードを書く前に、問題文のHTMLで指定を当てたい要素を先に確認しましょう。`.lv3`・`.lv4`・`#fafafa` は、対象を決めたあとに必要なタグ・セレクタ・値として入れると迷いにくくなります。
</Hint>
...
<Hint>
コードを書く前に、問題文のHTMLで指定を当てたい要素を先に確認しましょう。`.card`・`.tag`・`#ccc` は、対象を決めたあとに必要なタグ・セレクタ・値として入れると迷いにくくなります。
</Hint>
...
> [!TIP]
>
> **ヒント③「表示/非表示の切り替え（visibility）」**
> `visibility` プロパティで、要素の「見える／見えない」を切り替えることができます。  
> `visibility: hidden;` で非表示、`visibility: visible;` で表示されます。

<Hint>
コードを書く前に、問題文のHTMLで指定を当てたい要素を先に確認しましょう。`bottom`・`%`・`bottom: 30%;` は、対象を決めたあとに必要なタグ・セレクタ・値として入れると迷いにくくなります。
</Hint>
...
- `sticky`は通常の流れに残ったまま、スクロールして指定位置に達したときだけ貼り付く。親要素やスクロール範囲の影響を受けるため、見出しやサイドメニューなど、その要素の領域を確保したまま一時的に固定したい場合に便利。
