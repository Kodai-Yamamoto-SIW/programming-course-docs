...
import elementsCompleteHtmlUrl from './assets/elements-complete.html';
import manuscriptTextUrl from './assets/原稿.txt';
...
1. **まずは原稿.txtの内容をbodyにそのまま貼り付ける**
   ...
   <DownloadLink file={manuscriptTextUrl} filename="原稿.txt">原稿.txtをダウンロード</DownloadLink>
...
<DownloadLink file={elementsCompleteHtmlUrl} filename="elements-complete.html">
