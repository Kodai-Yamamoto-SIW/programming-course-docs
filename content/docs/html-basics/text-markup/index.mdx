...
export const picnicImageUrl = '/docs/html-basics/text-markup/assets/picnic.jpg';
export const parkMapImageUrl =
  '/docs/html-basics/text-markup/assets/park_map.jpg';
...
<a href="./assets/text-markup-complete.zip" download="text-markup-complete.zip">
