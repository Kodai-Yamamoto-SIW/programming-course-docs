...
export const parkMapImageUrl = '/docs/html-basics/text-markup/assets/park_map.jpg';
...
- <a href={picnicImageUrl} download="picnic.jpg">picnic.jpgをダウンロード</a>
- <a href={parkMapImageUrl} download="park_map.jpg">park_map.jpgをダウンロード</a>
...
<a
  href="./assets/text-markup-complete.zip"
