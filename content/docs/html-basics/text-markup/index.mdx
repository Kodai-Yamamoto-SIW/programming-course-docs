...
- <a
    href={createCourseDownloadUrl(picnicImageUrl, 'picnic.jpg')}
    download="picnic.jpg"
  >
    picnic.jpgをダウンロード
  </a>
- <a
    href={createCourseDownloadUrl(parkMapImageUrl, 'park_map.jpg')}
    download="park_map.jpg"
  >
    park_map.jpgをダウンロード
  </a>
...
<a
  href={createCourseDownloadUrl(
    textMarkupCompleteZipUrl,
