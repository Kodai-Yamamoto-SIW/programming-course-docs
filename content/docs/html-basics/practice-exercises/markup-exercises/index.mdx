...
import markupExercisesCompleteHtmlUrl from './assets/markup-exercises-complete.html';
import markupExercisesTextUrl from './assets/演習用原稿.txt';
...
<a
  href={createCourseDownloadUrl(markupExercisesTextUrl, '演習用原稿.txt')}
  download="演習用原稿.txt"
>
  演習用原稿.txtをダウンロード
</a>
...
<a
  href={createCourseDownloadUrl(markupExercisesCompleteHtmlUrl, 'markup-exercises-complete.html')}
