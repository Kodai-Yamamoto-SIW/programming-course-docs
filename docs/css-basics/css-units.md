...
**要求**:
- `h1`の文字サイズを32px、幅を画面幅の100%、背景色を青色（blue）に設定
- `h2`の文字サイズを親要素の1.5倍
- `p`の文字サイズをhtml要素の0.9倍
- `small`の文字サイズを親要素の0.8倍
...
h2 {
    font-size: 1.5em;   /* 親要素（body：16px）の1.5倍 = 24px */
}

p {
    font-size: 0.9rem;  /* html要素（16px）の0.9倍 = 14.4px */
}

small {
    font-size: 0.8em;   /* 親要素（p：14.4px）の0.8倍 = 11.52px */
}
```
